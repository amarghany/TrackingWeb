...
@Component({
  selector: 'app-edit-platinum-profit',
  imports: [ImportsModule],
  templateUrl: './edit-platinum-profit.html',
  styleUrl: './edit-platinum-profit.css',
})
export class EditPlatinumProfit {
  display = true;
  ...
  constructor(private fb: FormBuilder, private profiteService: PlatinumProfiteService, private cdr: ChangeDetectorRef,
  ...
  onGetSingleProfitClicked() {
      this.display = false;
      let item = {PLAT_PROFIT_ID:this.ProfiteId} as PlatinumProfite;
  ...
  onSubmit() {
    ...
    profit.PLAT_PROFIT_ID = this.ProfiteId;
